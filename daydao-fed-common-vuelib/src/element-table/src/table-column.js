...
export default {
  ...
  props: {
    ...
    align: String,
    headerAlign: String,
    showTooltipWhenOverflow: Boolean, //是否显示多余文字点点点
  ...
  created() {
    ...
    let column = getDefaultColumn(type, {
      ...
      showOverflowTooltip: this.showOverflowTooltip || this.showTooltipWhenOverflow,  //是否显示多余文字点点点
      ...
      index: this.index,
       helpTipText:this.helpTipText || ''  //表头标注
    });
